...
// string Rent_Due_Date, string Rent_Increase_Date, uint Security_Deposit_Amount,
// string Premises_Description, uint Daily_Animal_Restriction_Violation_Fee,
// string Landlord_Notice_Address, uint256 Effective_Date
//     );
}
